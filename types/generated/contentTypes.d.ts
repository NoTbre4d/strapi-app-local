...
export interface ApiOrdenCompraOrdenCompra extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cotizacion: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccion_entrega: Schema.Attribute.Text;
    fecha: Schema.Attribute.Date;
    fecha_planificada: Schema.Attribute.Date;
    incoterm: Schema.Attribute.Text;
    informacion_bancaria: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    terminos_pago: Schema.Attribute.String;
    tipo_compra: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrdenTrabajoOrdenTrabajo
  ...
  attributes: {
    ...
    fecha: Schema.Attribute.Date;
    herramientas: Schema.Attribute.JSON;
...
export interface ApiOrdenesTrabajoOrdenesTrabajo
  ...
  attributes: {
    asignado: Schema.Attribute.String;
...
export interface ApiRepuestoOrdenRepuestoOrden
  extends Struct.CollectionTypeSchema {
...
export interface ApiTikectTikect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tipoMantenimiento: Schema.Attribute.Enumeration<
